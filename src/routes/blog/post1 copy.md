...
i am not sure i love having a whole new file extension for basically vanilla html, but whatever, it works.

the blog portion of this site uses **mdsvex**, which lets me write all of these blog posts in markdown instead of html - so fucking cool. i would have gone insane had i needed to write html blogs...

this was also my first time using **tailwindcss**, which is actually pretty sick. i don't know if its worth poring over the docs every ten seconds for a personal website project, but it was a good learning experience should i need to use it in the future.
...
having a website reflect the essence of who i am as a person is a big ask, to the point where i still haven't really decided how i want this to look after months of this existing. i will eventually settle on something and update this section lol.
...
- [x] projects page
- actually implement list styling (this todo looks like ass right now)
- aesthetics (see design section)
